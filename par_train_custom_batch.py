...
if __name__ == '__main__':
    ...
    train_set = CustomDataset("../val","../validation_set.txt", transform, target_label=lbl)
    ...
    balanced_batch_sampler_train = BalancedBatchSampler(train_set,11,len(train_set))
    balanced_batch_sampler_val = BalancedBatchSampler(val_set,11,len(val_set))
    val_loader = DataLoader(val_set, batch_size=val_batch_size, shuffle=False, batch_sampler=balanced_batch_sampler_val)
    train_loader = DataLoader(train_set, batch_size=train_batch_size, shuffle=True, batch_sampler=balanced_batch_sampler_train)
